...
def test_get_locations_for_mx_90210_check_country_equals_mexico():
     response = requests.get("http://api.zippopotam.us/mx/90210")
     response_body = response.json()
     assert response_body["country"] == "Mexico"

def test_get_locations_for_mx_90210_check_city_equals_beverly_hills():
     response = requests.get("http://api.zippopotam.us/mx/90210")
     response_body = response.json()
     assert response_body["places"][0]["place name"] == "San Mateo Actipan"

def test_get_locations_for_mx_90210_check_one_place_is_returned():
     response = requests.get("http://api.zippopotam.us/mx/90210")
     response_body = response.json()
     assert len(response_body["places"]) == 1

def test_get_locations_for_mx_44440_check_one_place_is_returned():
     response = requests.get("http://api.zippopotam.us/mx/44440")
     response_body = response.json()
